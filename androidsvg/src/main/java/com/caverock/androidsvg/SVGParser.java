...
import com.caverock.androidsvg.tag.Path;
...
import com.caverock.androidsvg.tag.Defs;
...
import com.caverock.androidsvg.text.TextChild;
import com.caverock.androidsvg.text.TextContainer;
import com.caverock.androidsvg.text.TextPath;
import com.caverock.androidsvg.text.TextPositionedContainer;
import com.caverock.androidsvg.text.TextRoot;
...
class SVGParser extends DefaultHandler2 {
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        ...
        if (currentElement instanceof TextContainer) {
            ...
            if (previousSibling instanceof TextSequence) {
                ...
                ((TextSequence) previousSibling).text += new String(ch, start, length);
            } else {
                // Add a new TextSequence to the child node list
                currentElement.addChild(new TextSequence(new String(ch, start, length)));
            }
        }
    ...
    private void parseAttributesSVG(SvgViewBox obj, Attributes attributes) throws SAXException {
